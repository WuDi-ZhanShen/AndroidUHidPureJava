...
public class Hid {
    ...
    public static void main(String[] args) {
        ...
        Device gamePad = new Device(2, "uHidGamePad", 2345, 6789, 0x03, hidGamePadDescriptor, gamePadCode, null, null);
        Device touchScreen = new Device(2, "uHidTouchScreen", 6789, 2345, 0x03, hidTouchScreenDescriptor, touchScreenCode, null, null);
